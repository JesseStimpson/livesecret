defmodule LiveSecretWeb.UserListComponent do
  ...
  def dot(assigns) do
    ~H"""
    <%= if ActiveUser.connected?(@active_user) do %>
    <span class={"absolute bottom-0 right-0 block h-3 w-3 rounded-full bg-green-300 ring-2 ring-white"}></span>
    <% else %>
  ...
  defp badge_icon(assigns) do
    ...
    <svg class={"#{class} text-green-400"} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
      <path fill-rule="evenodd" d="M10 1a4.5 4.5 0 00-4.5 4.5V9H5a2 2 0 00-2 2v6a2 2 0 002 2h10a2 2 0 002-2v-6a2 2 0 00-2-2h-.5V5.5A4.5 4.5 0 0010 1zm3 8V5.5a3 3 0 10-6 0V9h6z" clip-rule="evenodd" />
    </svg>
    <% :unlock -> %>
    <svg class={"#{class} text-red-400"} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
    ...
    <% :bolt -> %>
    <svg class={"#{class} text-yellow-400"} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
      <path d="M11.983 1.907a.75.75 0 00-1.292-.657l-8.5 9.5A.75.75 0 002.75 12h6.572l-1.305 6.093a.75.75 0 001.292.657l8.5-9.5A.75.75 0 0017.25 8h-6.572l1.305-6.093z" />
    </svg>
    <% :shield -> %>
    <!-- Heroicon name: mini/shield-check -->
    <svg class={"#{class} text-gray-400"} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
    ...
    <% :beaker -> %>
    <svg class={"#{class} text-pink-400"} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
